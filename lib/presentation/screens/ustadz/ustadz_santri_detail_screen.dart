...
class UstadzSantriDetailScreen extends StatefulWidget {
  final SantriEntity santri;

  const UstadzSantriDetailScreen({super.key, required this.santri});

  @override
  State<UstadzSantriDetailScreen> createState() =>
      _UstadzSantriDetailScreenState();
}

class _UstadzSantriDetailScreenState extends State<UstadzSantriDetailScreen>
          ...
          InkWell(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => InputPenilaianScreen(santri: widget.santri),
                ),
              );
            },
            child: Container(
          ...
          Container(
            ...
            child: const Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Data nilai akan muncul setelah input penilaian',
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Data kehadiran akan muncul setelah input kehadiran',
                          style: TextStyle(
                            fontSize: 13,
                            color: Color(0xFF1E293B),
                          ),
